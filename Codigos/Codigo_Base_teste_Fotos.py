...
class Rastreamento_Peixe:
    ...
    def loop(self, pasta_com_imagens):
        ...
        cv2.resizeWindow('BINARIO', 800, 600)  
        cv2.namedWindow('PRINCIPAL', cv2.WINDOW_NORMAL)
        cv2.resizeWindow('PRINCIPAL', 800, 600)  
...
if __name__ == '__main__':
    pasta_com_imagens = 'C:\CODE\Projeto_Robo_tinik\Robot-fish\Codigos\Haar_Cascade\imagens\com_peixe' 
